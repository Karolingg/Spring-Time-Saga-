      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 380px', gap: '28px', alignItems: 'start' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
              ...
              <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
                <div style={{ display: 'flex', gap: '8px', flex: 1 }}>
                  <button onClick={undoLast} disabled={selectedVias.length === 0 && !selectedExit && !routeMode}
                    style={{ padding: '10px 12px', borderRadius: '8px', fontSize: '12px', fontWeight: 700, background: selectedVias.length === 0 && !selectedExit && !routeMode ? 'var(--bg-inset)' : 'var(--bg-card)', border: '1px solid var(--border)', color: selectedVias.length === 0 && !selectedExit && !routeMode ? 'var(--text-muted)' : 'var(--text-primary)', cursor: selectedVias.length === 0 && !selectedExit && !routeMode ? 'not-allowed' : 'pointer' }}>
                    Undo
                  </button>
                  <button onClick={resetPlan}
                    style={{ padding: '10px 12px', borderRadius: '8px', fontSize: '12px', fontWeight: 700, background: 'var(--bg-card)', border: '1px solid var(--border)', color: 'var(--text-primary)', cursor: 'pointer' }}>
                    Reset Plan
                  </button>
                </div>
          ...
          {(phase === 'running' || phase === 'rerouting') && (
            <>
              <div style={{ background: 'var(--bg-subtle)', border: '1px solid var(--border)', borderRadius: '12px', padding: '18px', boxShadow: '0 1px 0 rgba(0,0,0,0.02)' }}>
              ...
              <div style={{ background: 'var(--bg-subtle)', border: '1px solid var(--border)', borderRadius: '12px', padding: '14px', maxHeight: '180px', overflowY: 'auto', boxShadow: '0 1px 0 rgba(0,0,0,0.02)' }}>
          ...
          {phase === 'completed' && metrics && (
            <>
              ...
              {/* Evaluator */}
              <div style={{ background: 'var(--bg-subtle)', border: '1px solid var(--border)', borderRadius: '10px', padding: '14px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px' }}>
                <button onClick={reset}
                  style={{ padding: '11px', borderRadius: '10px', fontSize: '12px', fontWeight: 600, background: 'var(--bg-subtle)', border: '1px solid var(--border)', color: 'var(--text-primary)', cursor: 'pointer', transition: 'all 0.15s' }}>
                  Run Again
                </button>
