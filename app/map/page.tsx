      ...
      <div style={{
        ...
        {building && (
          <div style={{
            ...
            borderLeft: '1px solid rgba(45, 184, 176, 0.12)',
            ...
            <button onClick={() => setSelected(null)} style={{
              ...
              cursor: 'pointer', color: '#94a3b8', zIndex: 2,
            ...
            <div style={{ padding: '22px 22px 0' }}>
              <h2 style={{ margin: '0 0 4px', fontSize: '19px', fontWeight: '700', color: '#f1f5f9', paddingRight: '36px' }}>
                {building.name}
              </h2>
              ...
              <div style={{ display: 'flex', gap: '8px', marginBottom: '18px', flexWrap: 'wrap' }}>
                ...
                <span style={{
                  display: 'inline-flex', alignItems: 'center', gap: '5px',
                  padding: '4px 12px', borderRadius: '20px',
                  background: `${RISK_COLORS[building.riskLevel]}15`,
                  color: RISK_COLORS[building.riskLevel],
                  fontSize: '11px', fontWeight: '600',
                  border: `1px solid ${RISK_COLORS[building.riskLevel]}40`,
                }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '16px' }}>
                ...
                <div style={{
                  ...
                  <svg width="72" height="72" viewBox="0 0 72 72">
                    ...
                    <circle cx="36" cy="36" r="28" fill="none" stroke="#2db8b0" strokeWidth="6"
                      strokeDasharray={`${(building.capacity / 500) * 175.9} 175.9`}
                      strokeLinecap="round" transform="rotate(-90 36 36)" />
                    <text x="36" y="34" textAnchor="middle" fill="#f1f5f9" fontSize="16" fontWeight="700">{building.capacity}</text>
                    <text x="36" y="46" textAnchor="middle" fill="#64748b" fontSize="8" fontWeight="500">people</text>
                  </svg>
                  <span style={{ fontSize: '11px', color: '#64748b', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Capacity</span>
                </div>
                ...
                <div style={{
                  ...
                  <svg width="72" height="72" viewBox="0 0 72 72">
                    ...
                    <circle cx="36" cy="36" r="28" fill="none" stroke="#f59e0b" strokeWidth="6"
                      strokeDasharray={`${(building.floors / 5) * 175.9} 175.9`}
                      strokeLinecap="round" transform="rotate(-90 36 36)" />
                    <text x="36" y="34" textAnchor="middle" fill="#f1f5f9" fontSize="16" fontWeight="700">{building.floors}</text>
                    <text x="36" y="46" textAnchor="middle" fill="#64748b" fontSize="8" fontWeight="500">levels</text>
                  </svg>
                  <span style={{ fontSize: '11px', color: '#64748b', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Floors</span>
                </div>
              </div>

              {/* Exits + Last Drill row */}
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '18px' }}>
                <div style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '8px' }}>
                    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#64748b" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg>
                    <span style={{ fontSize: '10px', color: '#64748b', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Exits</span>
                  </div>
                  <div style={{ fontSize: '22px', fontWeight: '700', color: '#f1f5f9' }}>{building.exits}</div>
                </div>
                <div style={{
                  padding: '14px', background: 'rgba(255,255,255,0.03)', borderRadius: '12px',
                  border: '1px solid rgba(255,255,255,0.06)',
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '8px' }}>
                    ...
                    <span style={{ fontSize: '10px', color: '#64748b', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Last Drill</span>
                  </div>
