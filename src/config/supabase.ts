...
const hasPlaceholderConfig = SUPABASE_URL === 'https://placeholder.supabase.co' || SUPABASE_ANON_KEY === 'placeholder-anon-key'
export const isSupabaseConfigured = hasSupabaseEnv && !hasPlaceholderConfig
