...
const MANAGEMENT_2F: FloorConfig = {
  ...
  exits: {
    E1: { x: 915, y: 345, label: 'E1', desc: '' },
    E2: { x: 285, y: 370, label: 'E2', desc: '' },
  },
  startPos: { x: 0, y: 0 },
  primaryPaths: {
    E1: [{ x: 490, y: 350 }, { x: 490, y: 295 }, { x: 420, y: 270 }, { x: 410, y: 210 }, { x: 410, y: 120 }, { x: 410, y: 52 }],
    E2: [{ x: 285, y: 370 }, { x: 285, y: 310 }, { x: 350, y: 290 }, { x: 410, y: 210 }, { x: 410, y: 120 }, { x: 285, y: 430 }],
  },
  ...
  rooms: {
    corridor: { label: 'Corridor', x: 490, y: 350 },
    som203: { label: 'Management 203', x: 690, y: 330, corridorEntryNode: ''},
    som204: { label: 'Management 204', x: 450, y: 330, corridorEntryNode: '' },
  },
  corridorNodes: [
    { label: 'Management 204 Entry', x: 435, y: 330, neighbors: ['Management 204 Exit', 'Management 204 Entrance'] },
    { label: 'Management 204 Exit', x: 342, y: 385, neighbors: ['Management 204 Entry', 'Near Toilet'] },
    { label: 'Management 204 Entrance', x: 527, y: 385, neighbors: ['Management 204 Entry', 'Out Management 204'] },
    { label: 'Management 203 Entry', x: 690, y: 330, neighbors: ['Management 203 Exit', 'Management 203 Entrance'] },
    { label: 'Management 203 Exit', x: 601, y: 385, neighbors: ['Out Management 203 Exit', 'Management 203 Entry'] },
    { label: 'Management 203 Entrance', x: 785, y: 385, neighbors: ['Out Management 203 Entrance', 'Management 203 Entry'] },
    { label: 'Out 204 ', x: 342, y: 430, neighbors: ['Management 204 Exit', 'Out Management 204', 'Near Exit 2'] },
    { label: 'Out Management 204', x: 538, y: 430, neighbors: ['Near Toilet', 'Management 204 Entrance', 'Management 203 Exit'] },
    ...
    { label: 'Near Stairs', x: 915, y: 430, neighbors: ['Out Management 203 Entrance', 'E1'] },
    { label: 'Near Exit 2', x: 285, y: 430, neighbors: ['Out 204', 'E2'] },
  ],
}
