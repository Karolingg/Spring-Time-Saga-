...
const ASX_1F: FloorConfig = {
  ...
  rooms: {
    ...
    asx101: { label: 'ASX 101', x: 600, y: 250, corridorEntryNode: 'ASX 101 Entry'},
    asx102: { label: 'ASX 102', x: 875, y: 250, corridorEntryNode: 'ASX 102 Entry' },
    asx103: { label: 'ASX 103', x: 560, y: 375, corridorEntryNode: 'ASX 103 Entry' },
    asx104: { label: 'ASX 104', x: 820, y: 375, corridorEntryNode: 'ASX 104 Entry' },
  },
  corridorNodes: [
    { label: 'ASX 101 Exit', x: 493, y: 260, neighbors: ['Corridor 1'] },
    { label: 'ASX 101 Entrance', x: 692, y: 260, neighbors: ['Left Corridor', 'Upper Corridor'] },
    ...
    { label: 'ASX 102 Entrance', x: 978, y: 280, neighbors: ['Left Corridor', 'Upper Corridor'] },
