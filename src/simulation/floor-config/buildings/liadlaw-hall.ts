...
const LIADLAW_HALL_1F: FloorConfig = createGroundFloorConfig('1st Floor')
const LIADLAW_HALL_2F: FloorConfig = createUpperFloorConfig('2nd Floor')

export const LIADLAW_HALL_FLOORS: FloorConfig[] = [
  LIADLAW_HALL_1F,
  LIADLAW_HALL_2F,
]
