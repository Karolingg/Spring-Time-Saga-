...
const SOM_BUILDING_1_1F: FloorConfig = createGroundFloorConfig('1st Floor')
const SOM_BUILDING_1_2F: FloorConfig = createUpperFloorConfig('2nd Floor')
const SOM_BUILDING_1_3F: FloorConfig = createUpperFloorConfig('3rd Floor')

export const SOM_BUILDING_1_FLOORS: FloorConfig[] = [
  SOM_BUILDING_1_1F,
  SOM_BUILDING_1_2F,
  SOM_BUILDING_1_3F,
]
