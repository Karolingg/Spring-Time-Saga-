...
const UP_HIGH_SCHOOL_1F: FloorConfig = createGroundFloorConfig('1st Floor')
const UP_HIGH_SCHOOL_2F: FloorConfig = createUpperFloorConfig('2nd Floor')

export const UP_HIGH_SCHOOL_FLOORS: FloorConfig[] = [
  UP_HIGH_SCHOOL_1F,
  UP_HIGH_SCHOOL_2F,
]
