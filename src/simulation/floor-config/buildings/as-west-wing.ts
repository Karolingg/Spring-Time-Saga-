...
const AS_WEST_WING_2F: FloorConfig = {
  ...
  primaryPaths: {
    ...
    E4: [{ x: 490, y: 350 }, { x: 490, y: 410 }, { x: 490, y: 455 }, { x: 430, y: 470 }, { x: 370, y: 490 }],
  ...
  corridorNodes: [
    { label: 'Central Corridor', x: 523, y: 300, neighbors: ['Out OAR', 'E1'] },
    { label: 'Out OAR', x: 427, y: 335, neighbors: ['Office of Alumni Relations', 'Out 261', 'Central Corridor'] },
    ...
    { label: 'Out 250', x: 1038, y: 335, neighbors: ['Out 249', 'Near E4 & E5'] },
    { label: 'Out 249', x: 943, y: 335, neighbors: ['Out 250', 'Out 248'] },
    { label: 'Out 248', x: 830, y: 335, neighbors: ['Out 247', 'Out 249'] },
    { label: 'Out 247', x: 744, y: 335, neighbors: ['Out 248', 'Out 261'] },
    { label: 'Out 261', x: 523, y: 335, neighbors: ['Central Corridor', 'Out 247'] },
    { label: 'Out NSTP Office', x: 295, y: 335, neighbors: ['Out 259', 'Out Iskultura Office '] },
...
const AS_WEST_WING_3F: FloorConfig = {
  ...
  rooms: {
    ...
    r03: { label: 'R03', x: 155, y: 310, corridorEntryNode: '' },
    r04: { label: 'R04', x: 744, y: 360, corridorEntryNode: '' },
    r05: { label: 'R05', x: 293, y: 310, corridorEntryNode: '' },
    r06: { label: 'R06', x: 427, y: 310, corridorEntryNode: '' },
    r07: { label: 'R07', x: 360, y: 355, corridorEntryNode: '' },
    r08: { label: 'R08', x: 265, y: 355, corridorEntryNode: '' },
    ...
    lo4: { label: 'LO4', x: 943, y: 310, corridorEntryNode: '' },
  ...
  corridorNodes: [
    { label: 'Near Stairs', x: 523, y: 300, neighbors: ['Out OAR', 'E1'] },
    ...
    { label: 'Out R03', x: 155, y: 335, neighbors: ['259 Entry', 'Out NSTP Office', 'Near E2 & E3'] },
    { label: 'Out LO1 & LO2', x: 1090, y: 335, neighbors: ['Out LO3 & LO4', 'Near E4 & E5'] },
    { label: 'Out LO3 & LO4', x: 943, y: 335, neighbors: ['Out LO1 & LO2', 'Out LO7'] },
    { label: 'Out LO7', x: 830, y: 335, neighbors: ['Out LO8', 'Out LO3 & LO4'] },
    { label: 'Out LO8', x: 744, y: 335, neighbors: ['Central Corridor', 'Out LO7'] },
    { label: 'Central Corridor', x: 523, y: 335, neighbors: ['Central Corridor', 'Near Stairs'] },
    { label: 'Out R05', x: 295, y: 335, neighbors: ['Out R07', 'Out R08'] },
    { label: 'Out R08', x: 265, y: 335, neighbors: ['Out R03', 'Out R05'] },
    { label: 'Out R07', x: 360, y: 335, neighbors: ['Out R06', 'Out R05'] },
    { label: 'Out R06', x: 427, y: 335, neighbors: ['Out R07', 'Central Corridor', 'Near Stairs'] },
    { label: 'Near E2 & E3', x: 68, y: 335, neighbors: ['Out 259', '259 Exit', 'E2', 'E3'] },
    { label: 'Near E4 & E5', x: 1132, y: 335, neighbors: ['Out 250', 'E4', 'E5'] },
  ],
}
